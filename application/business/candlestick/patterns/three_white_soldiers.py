...
class ThreeWhiteSoldiers(CandlestickFinder):
    ...
    def logic(self, idx):
        ...
        is_up_trend = prev_high > b_prev_high and high > prev_high
        is_all_bullish = b_prev_open < b_prev_close and prev_open < prev_close and open < close
        does_open_within_previous_body = b_prev_close > prev_open and prev_open <  b_prev_high and prev_high > open  and open < prev_close

        return (is_up_trend and is_all_bullish and does_open_within_previous_body)
